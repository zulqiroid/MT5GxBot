...
PHASE_8_OFFLINE_REPLAY_SUCCESSIVE_ITERATIVE_RECURRENT_BOUNDED_STATE_ACTIVE = "ACTIVE"
PHASE_8_OFFLINE_REPLAY_SUCCESSIVE_ITERATIVE_RECURRENT_BOUNDED_STATE_COMPLETED = "COMPLETED"
...
class Phase8OfflineReplaySuccessiveIterativeRecurrentBoundedProgressedSessionState:
...
@dataclass(frozen=True, slots=True)
class Phase8OfflineReplaySuccessiveIterativeRecurrentBoundedProgressedSessionStateDecision:
    """Allowed or blocked successive recurrent progressed-state result."""

    is_allowed: bool
    state: Phase8OfflineReplaySuccessiveIterativeRecurrentBoundedProgressedSessionState | None
    blockers: tuple[str, ...]
...
class StrategyPhase8OfflineReplaySuccessiveIterativeRecurrentBoundedProgressedStateFactory:
    ...
    def create(
        ...
        if application_decision is None:
            return Phase8OfflineReplaySuccessiveIterativeRecurrentBoundedProgressedSessionStateDecision(
                is_allowed=False,
                state=None,
        ...
        lifecycle = (
            ...
            else PHASE_8_OFFLINE_REPLAY_SUCCESSIVE_ITERATIVE_RECURRENT_BOUNDED_STATE_ACTIVE
        )

        try:
            state = Phase8OfflineReplaySuccessiveIterativeRecurrentBoundedProgressedSessionState(
...
def create_phase8_offline_replay_successive_iterative_recurrent_bounded_progressed_state(
    application_decision: object,
) -> Phase8OfflineReplaySuccessiveIterativeRecurrentBoundedProgressedSessionStateDecision:
    """Create one immutable reusable successive progressed state."""

    return StrategyPhase8OfflineReplaySuccessiveIterativeRecurrentBoundedProgressedStateFactory().create(
        application_decision
    )
