"""Immutable further continued successive iterative recurrent bounded replay plan.
...
PHASE_8_OFFLINE_REPLAY_FURTHER_CONTINUED_SUCCESSIVE_ITERATIVE_RECURRENT_BOUNDED_PLAN_SCHEMA_VERSION = "1.0"
PHASE_8_OFFLINE_REPLAY_FURTHER_CONTINUED_SUCCESSIVE_ITERATIVE_RECURRENT_BOUNDED_DEFAULT_LIMIT = 32
...
class Phase8OfflineReplayFurtherContinuedSuccessiveIterativeRecurrentBoundedPlan:
    """Immutable plan for one further continued recurrent bounded replay window."""
...
@dataclass(frozen=True, slots=True)
class Phase8OfflineReplayFurtherContinuedSuccessiveIterativeRecurrentBoundedPlanDecision:
    """Allowed or blocked further continued recurrent bounded planning result."""

    is_allowed: bool
    plan: Phase8OfflineReplayFurtherContinuedSuccessiveIterativeRecurrentBoundedPlan | None
    blockers: tuple[str, ...]
...
class StrategyPhase8OfflineReplayFurtherContinuedSuccessiveIterativeRecurrentBoundedPlanner:
    """Plans one further continued successive recurrent bounded replay window."""
    ...
    def generate(
        ...
        *,
        ...
        try:
            plan = Phase8OfflineReplayFurtherContinuedSuccessiveIterativeRecurrentBoundedPlan(
            ...
            return (
                Phase8OfflineReplayFurtherContinuedSuccessiveIterativeRecurrentBoundedPlanDecision(
                    ...
                    plan=None,
                    blockers=(
                        "further_continued_successive_iterative_recurrent_plan_invalid:"
                        f"{type(error).__name__}",
                    ),
                )
            )

        return Phase8OfflineReplayFurtherContinuedSuccessiveIterativeRecurrentBoundedPlanDecision(
            is_allowed=True,
            plan=plan,
            blockers=(),
        )
...
def generate_phase8_offline_replay_further_continued_successive_iterative_recurrent_bounded_plan(
    source_decision: object,
    *,
    transition_limit: int = (
        PHASE_8_OFFLINE_REPLAY_FURTHER_CONTINUED_SUCCESSIVE_ITERATIVE_RECURRENT_BOUNDED_DEFAULT_LIMIT
    ...
    """Generate one immutable further continued successive recurrent plan."""

    return StrategyPhase8OfflineReplayFurtherContinuedSuccessiveIterativeRecurrentBoundedPlanner().generate(
        source_decision,
        transition_limit=transition_limit,
    )
